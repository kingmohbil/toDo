...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CreateSideBarProject": () => (/* binding */ CreateSideBarProject),
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _toggeling__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toggeling */ "./src/toggeling.js");
...
function printEveryTask(){
  for(let i = 0; i < localStorage.length; i++){
    ...
    const test = new _toDoClasses__WEBPACK_IMPORTED_MODULE_1__.toDoFunctions(JSON.parse(localStorage.getItem(localStorage.key(i))))
...
function printTodayOnly(){
  for(let i = 0; i < localStorage.length; i++){
    if((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(),new Date(JSON.parse(localStorage.getItem(localStorage.key(i))).dueDate)))
      {
        const temp = new _toDoClasses__WEBPACK_IMPORTED_MODULE_1__.toDoFunctions(JSON.parse(localStorage.getItem(localStorage.key(i))))
...
newProject.addEventListener('click', ()=>{
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.addActive)(projectForm)
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.addActive)(projectInput)
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.addActive)(projectClose)
})
projectClose.addEventListener('click', ()=>{
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.removeActive)(projectInput)
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.removeActive)(projectClose)
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.removeActive)(projectForm)
})
addBtn.addEventListener('click', () => {
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.addActive)(formContainer)
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.addActive)(overlay)
})
closeBtn.addEventListener('click', () => {
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.removeActive)(overlay)
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.removeActive)(formContainer)
})

form.onsubmit = () => {
    localStorage.setItem(form.titleInput.value,JSON.stringify((0,_toDoClasses__WEBPACK_IMPORTED_MODULE_1__.toDoItem)(form.titleInput.value,
        form.descriptionInput.value, (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(form.dueDateInput.value), "MM/dd/yyyy"), 
...
inbox.addEventListener('click', () =>{
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.addActive)(inbox)
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.removeActive)(today)
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.removeActive)(upcoming)
...
today.addEventListener('click', () =>{
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.addActive)(today)
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.removeActive)(inbox)
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.removeActive)(upcoming)
...
upcoming.addEventListener('click', () =>{
  ...
  cardsConatiner.innerHTML = ""
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.addActive)(upcoming)
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.removeActive)(today)
  ;(0,_toggeling__WEBPACK_IMPORTED_MODULE_0__.removeActive)(inbox)
  for(let i = 0; i < localStorage.length; i++){
    if((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(JSON.parse(localStorage.getItem(localStorage.key(i))).dueDate), new Date()))
      {
        const temp = new _toDoClasses__WEBPACK_IMPORTED_MODULE_1__.toDoFunctions(JSON.parse(localStorage.getItem(localStorage.key(i))))
        temp.print(cardsConatiner)
      }
